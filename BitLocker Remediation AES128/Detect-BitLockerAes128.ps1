...
try {
    ...
    Write-Log "Starting BitLocker XtsAes128 detection for OS drive $MountPoint."
    ...
    if ($volume.EncryptionMethod -ne 'XtsAes128') {
        Exit-NonCompliant "Encryption method is '$($volume.EncryptionMethod)', expected 'XtsAes128'."
    }
    ...
    Exit-Compliant "Device is compliant. $MountPoint is protected with BitLocker XtsAes128, fully encrypted, and TPM is ready."
}
catch {
